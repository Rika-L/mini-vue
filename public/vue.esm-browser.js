...
function isMemberExpressionBrowser(exp) {
...
function transformBind(dir, _node, context) {
...
function transformBindShorthand(dir, context) {
  const arg = dir.arg
...
function trackSlotScopes(node, context) {
...
function buildClientSlotFn(props, _vForExp, children, loc) {
...
function transformOn$1(dir, node, context, augmentor) {
...
function transformModel$1(dir, node, context) {
  const { exp, arg } = dir
  if (!exp) {
    context.onError(
...
function transformVHtml(dir, node, context) {
  const { exp, loc } = dir
  if (!exp) {
    context.onError(
...
function transformVText(dir, node, context) {
  const { exp, loc } = dir
  if (!exp) {
    context.onError(
...
function resolveModifiers(key, modifiers, context, loc) {
  const keyModifiers = []
...
function transformClick(key, event) {
...
function ignoreSideEffectTags(node, context) {
...
export { assertNumber, BaseTransition, BaseTransitionPropsValidators, callWithAsyncErrorHandling, callWithErrorHandling, camelize, capitalize, cloneVNode, Comment, compatUtils, compileToFunction as compile, computed, createApp, createBlock, createCommentVNode, createElementBlock, createBaseVNode as createElementVNode, createHydrationRenderer, createPropsRestProxy, createRenderer, createSlots, createSSRApp, createStaticVNode, createTextVNode, createVNode, customRef, defineAsyncComponent, defineComponent, defineCustomElement, defineEmits, defineExpose, defineModel, defineOptions, defineProps, defineSlots, defineSSRCustomElement, DeprecationTypes, devtools, effect, EffectScope, effectScope, ErrorCodes, ErrorTypeStrings, Fragment, getCurrentInstance, getCurrentScope, getCurrentWatcher, getTransitionRawChildren, guardReactiveProps, h, handleError, hasInjectionContext, hydrate, hydrateOnIdle, hydrateOnInteraction, hydrateOnMediaQuery, hydrateOnVisible, initCustomFormatter, initDirectivesForSSR, inject, isMemoSame, isProxy, isReactive, isReadonly, isRef, isRuntimeOnly, isShallow, isVNode, KeepAlive, markRaw, mergeDefaults, mergeModels, mergeProps, nextTick, normalizeClass, normalizeProps, normalizeStyle, onActivated, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onErrorCaptured, onMounted, onRenderTracked, onRenderTriggered, onScopeDispose, onServerPrefetch, onUnmounted, onUpdated, onWatcherCleanup, openBlock, popScopeId, provide, proxyRefs, pushScopeId, queuePostFlushCb, reactive, ReactiveEffect, readonly, ref, registerRuntimeCompiler, render, renderList, renderSlot, resolveComponent, resolveDirective, resolveDynamicComponent, resolveFilter, resolveTransitionHooks, setBlockTracking, setDevtoolsHook, setTransitionHooks, shallowReactive, shallowReadonly, shallowRef, ssrContextKey, ssrUtils, Static, stop, Suspense, Teleport, Text, toDisplayString, toHandlerKey, toHandlers, toRaw, toRef, toRefs, toValue, TrackOpTypes, transformVNodeArgs, Transition, TransitionGroup, TriggerOpTypes, triggerRef, unref, useAttrs, useCssModule, useCssVars, useHost, useId, useModel, useShadowRoot, useSlots, useSSRContext, useTemplateRef, useTransitionState, version, vModelCheckbox, vModelDynamic, vModelRadio, vModelSelect, vModelText, vShow, VueElement, warn, watch, watchEffect, watchPostEffect, watchSyncEffect, withAsyncContext, withCtx, withDefaults, withDirectives, withKeys, withMemo, withModifiers, withScopeId }
