...
describe("runtime-core: render", () => {
  ...
  it("diff: 尾部增加新节点", () => {
    ...
    const container = document.createElement('div')
    render(vnode1, container)
    expect(container.innerHTML).toBe('<div key="a"><div key="b"></div><div key="c"></div></div>');
    render(vnode2, container)
    expect(container.innerHTML).toBe('<div key="a"><div key="b"></div><div key="c"></div><div key="d"></div></div>');
  })
  ...
  it('diff: 头部增加新节点', () => {
    ...
    expect(container.innerHTML).toBe('<div key="a"><div key="b"></div><div key="c"></div></div>');
    render(vnode2, container)
    expect(container.innerHTML).toBe('<div key="a"><div key="d"></div><div key="b"></div><div key="c"></div></div>');
  });
